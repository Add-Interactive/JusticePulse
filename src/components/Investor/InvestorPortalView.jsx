...
export default function InvestorPortalView({ 
  ...
  return (
    <div className={`fixed inset-0 z-50 bg-[#080c14] text-white flex flex-col overflow-y-auto selection:bg-purple-600 selection:text-white select-none ${currentTheme} ${isHighContrast ? 'high-contrast-mode' : ''}`}>
      {/* Full-Screen Sticky Header Bar */}
      <header className="sticky top-0 z-40 bg-[#0c101c]/98 backdrop-blur-md border-b-2 border-purple-800/60 px-4 sm:px-8 py-3 flex items-center justify-between shadow-2xl flex-shrink-0">
        {/* Left: Brand Identity */}
        <div className="flex items-center space-x-3">
          <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-2xl bg-gradient-to-br from-purple-500 via-pink-500 to-indigo-600 p-0.5 shadow-glow flex items-center justify-center flex-shrink-0">
          ...
          <div>
            <div className="flex items-center space-x-2">
              <span className="font-display font-black text-base sm:text-lg tracking-tight text-white">
                JUSTICE<span className="text-purple-400">PULSE</span>
              </span>
              <span className="text-[9px] font-mono px-2 py-0.5 rounded-full bg-purple-950 text-purple-200 border border-purple-600 font-bold hidden sm:inline">
                CAPITAL PORTAL
              </span>
            </div>
            <p className="text-[10px] text-purple-200/80 font-mono hidden md:block leading-none">
              Series Seed Financing &amp; Full Production Release OS
            </p>
          </div>
        </div>

        {/* Center: Live Round Ticker */}
        <div className="hidden lg:flex items-center space-x-3 text-xs font-mono bg-[#111726] px-3.5 py-1.5 rounded-2xl border border-purple-700/60">
          <span className="text-purple-300 font-bold">$3.5M SEED ROUND</span>
          <span className="text-slate-500">•</span>
          <span className="text-slate-300">$18.5M PRE-MONEY</span>
          <span className="text-slate-500">•</span>
          <span className="text-emerald-400 font-bold">82% GROSS MARGIN</span>
        </div>
        ...
        <div className="flex items-center space-x-2 sm:space-x-3 text-xs">
          ...
          {onOpenEvidenceSuite && (
            <button
              ...
              className="hidden sm:flex items-center space-x-1.5 px-3 py-1.5 rounded-xl bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-500 hover:to-indigo-500 text-white font-mono font-bold shadow-glow transition-all"
            >
          ...
          {onClose && (
            <button
              ...
              title="Close Investor Portal and Return to Main Platform"
            >
